                                ...
                                {permission_module?.map((n,index)=>{
                                    return (
                                        <div   style={{width:'100%',gap:"4px" ,height:'100%', transition: 'all 300ms',display:'flex' ,alignItems:'center' ,justifyContent:'flex-start'}} 
                                            ...
                                            >
                                               <span style={{display:'flex',justifyContent:'center',textAlign:'center',alignItems:'center',height:'5px',width:'12px'}}><input type="checkbox" checked={datalist?.role_permissions.includes(n)} onChange={() => handleCheckboxChange(n)} style={{cursor:'pointer'}}/></span>
                              
                                                <span style={{display:'flex',justifyContent:'center',alignItems:'center',fontSize:"12px"}}>{n}</span>
                                            </div>
                                    )
                                })}
