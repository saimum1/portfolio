...
const OfferCenter = () =>{
    ...
    const [offerList,setofferList]=useState([{
        ...
        operator:'Vodaphone',
        offer_details:'VODAFONE - SOLO PER STRANIERI NON PUOI ACQUISTARE CITTADINANZA ITALIANA - Ricaricabile ......',
        default_price:'23.00',
        agent_price:'30.00',
        entry_date:'12-20-2023',
        iban:'No',
        status:'active'
    },{
        operator:'ho.',
    ...
    const GetofferList = async () => {
        try {
            ...
            setofferList(response.data.SIMCards)
...
const handleCopyUID = (uid) => {
  ...
  return (
    ...
    <AddnewUser  isOpen={isOpen} onClose={onClose} data={selecteditem} action={actiontype}  getdata={getdataforadd}/>

    <ViewOfferCenter   isOpen={isOpenoff} onClose={onCloseoff} data={selecteditem} action={actiontype}  getdata={getdataforadd}/>
        ...
        <Table className="mt-5">
            <TableHead>
                <TableRow className="!bg-[#444444] !rounded !rounded-1xl" style={{margin:'0px 4px',backgroundColor:'red'}}>
                    ...
                    <TableHeaderCell style={{borderRight:'2px solid #303038'}}>Offer details</TableHeaderCell>
            ...
            <TableBody  >
                ...
                {offerList?.map((item,index) => (
                    <TableRow key={index} style={{borderColor:'#595959'}}>
                        ...
                        <TableCell>
                          <Text className={item.iban==='no'? "!text-[#E55245]" : "!text-white"}>{item.iban}</Text>
                        </TableCell>
